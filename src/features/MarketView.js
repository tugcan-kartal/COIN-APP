...
const MarketView = () => {
  ...
  useEffect(() => {
    dispatch(fetchCoinList()); // İlk yüklemede verileri çek
    ...
    <div className="bg-purple-800">
      ...
      {coinListData.length > 0 && (
        <div className="w-[80vw] mx-auto">
          <div id="market" className="text-white text-4xl font-bold mb-[5vh]">
            Market
          </div>
          ...
          <div>
            {coinListData.map((coin, key) => (
              <div
                className="h-[15vh] flex items-center justify-between border-b-2 border-white text-xl text-white font-medium hover:opacity-50"
                key={key}
              >
                ...
                <div className="md:visible invisible">$ {coin.market_cap}</div>
              </div>
            ))}
          </div>
          ...
          <div className="flex justify-center gap-x-[5vw] py-[5vh]">
            <div
              className="text-white bg-purple-500 text-lg px-[2vw] md:px-[1vw] py-[0.5vh] rounded-full cursor-pointer"
              onClick={() => {
